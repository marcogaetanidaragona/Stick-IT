...
variable testTypeDynamic RelativeNormDispIncr;	# Convergence-test type
#set testType $testTypeDynamic
#test $testTypeDynamic $TolDynamic $maxNumIterDynamic $printFlagDynamic;
## for improved-convergence procedure:
#	variable maxNumIterConvergeDynamic 400;	
#	variable printFlagConvergeDynamic 0;
#	
#	
	variable testType EnergyIncr;
...
set iterAlgo $algorithmTypeDynamic
